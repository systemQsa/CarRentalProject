...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li>  <a href="?action=pagination&required=viewOrders&viewSuchOrders=approved&page=1">${sessionScope.language['Approved_orders']}</a></li>
            <li> <a href="?action=pagination&required=viewOrders&viewSuchOrders=declined&page=1">${sessionScope.language['Declined_orders']}</a></li>
