                ...
                <c:if test="${requestScope.currentPage == 1}">
                    <ul class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><a class="dropdown-item text-decoration-none"
                                                       href="?action=pagination&required=viewCars&page=${requestScope.currentPage}&noOfRecords=5">5</a>
                            </li>
                            <li role="presentation"><a class="dropdown-item text-decoration-none"
                                                       href="?action=pagination&required=viewCars&page=${requestScope.currentPage}&noOfRecords=10">10</a>
                            </li>
                            <li role="presentation"><a class="dropdown-item text-decoration-none"
                                                       href="?action=pagination&required=viewCars&page=${requestScope.currentPage}&noOfRecords=25">25</a>
                            </li>
                            <li role="presentation"><a class="dropdown-item text-decoration-none"
                                                       href="?action=pagination&required=viewCars&page=${requestScope.currentPage}&noOfRecords=50">50</a>
                            </li>
                        </ul>
                    </ul>
                </c:if>
                            ...
                            <c:choose>
                                <c:when test="${sessionScope.role == null}">
                                    <a href="#modalColor" data-target-color="lightblue" data-toggle="modal"
                                       class="btn btn-warning" role="button">${sessionScope.language['Book_Car']}</a>
                                </c:when>
            ...
            <div class="text-center">
                ...
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item"><a class="page-link"
                                             href="?action=pagination&required=viewCars&page=1&noOfRecords=${requestScope.noOfRecords}">1</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="?action=pagination&required=viewCars&page=2&noOfRecords=${requestScope.noOfRecords}">2</a>
                    </li>
                    <li class="page-item"><a class="page-link"
                                             href="?action=pagination&required=viewCars&page=3&noOfRecords=${requestScope.noOfRecords}">3</a>
                    </li>
                    <li class="page-item">
                    ...
                    <table class="table table-hover">
                        <c:if test="${requestScope.currentPage == 1}">
                            <ul class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation"><a class="dropdown-item text-decoration-none"
                                                               href="?sort=sorting&action=wantedOrder&order=${requestScope.order}&page=${requestScope.currentPage}&noOrRecordsSorted=5"
                                                               role="button">5</a></li>
                                    <li role="presentation"><a class="dropdown-item text-decoration-none"
                                                               href="?sort=sorting&action=wantedOrder&order=${requestScope.order}&page=${requestScope.currentPage}&noOrRecordsSorted=10"
                                                               role="button">10</a></li>
                                    <li role="presentation"><a class="dropdown-item text-decoration-none"
                                                               href="?sort=sorting&action=wantedOrder&order=${requestScope.order}&page=${requestScope.currentPage}&noOrRecordsSorted=25"
                                                               role="button">25</a></li>
                                    <li role="presentation"><a class="dropdown-item text-decoration-none"
                                                               href="?sort=sorting&action=wantedOrder&order=${requestScope.order}&page=${requestScope.currentPage}&noOrRecordsSorted=50"
                                                               role="button">50</a></li>
                                </ul>
                            </ul>
                        </c:if>
                                    ...
                                    <c:choose>
                                        <c:when test="${sessionScope.role == null}">
                                            <a href="#modalColor" data-target-color="lightblue" data-toggle="modal"
                                               ...
                                               role="button">${sessionScope.language['Book_Car']}</a>
                                        </c:when>
                                        <c:when test="${sessionScope.role eq 'user'}">
            ...
            <c:if test="${not empty requestScope.sortedCars}">
                <div class="text-center">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item">
                            <a class="page-link"
                               href="?sort=sorting&action=wantedOrder&order=${requestScope.order}&page=1&noOrRecordsSorted=${requestScope.noOrRecordsSorted}">1</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link"
                               href="?sort=sorting&action=wantedOrder&order=${requestScope.order}&page=2&noOrRecordsSorted=${requestScope.noOrRecordsSorted}">2</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link"
                               href="?sort=sorting&action=wantedOrder&order=${requestScope.order}&page=3&noOrRecordsSorted=${requestScope.noOrRecordsSorted}">3</a>
                        </li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer bg-info">
                        ...
                        <button type="button" class="btn btn-link"
                                data-dismiss="modal">${sessionScope.language['Close']}</button>
                    </div>
                </div>
            </div>
        </div>
