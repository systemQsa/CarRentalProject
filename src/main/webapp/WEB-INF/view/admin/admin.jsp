            ...
            <tr>
                ...
                <td>
                    <form method="post" action="${pageContext.request.contextPath}/helloServlet">
                        ...
                        <button type="submit" name="action" value="block" class="btn btn-danger btn-sm">${sessionScope.language['Block_user']}</button>
                        <button type="submit" name="action" value="unblock" class="btn btn-success btn-sm">${sessionScope.language['Unblock_user']}</button>
                        <button type="submit" name="action" value="setManager" class="btn btn-primary btn-sm">${sessionScope.language['Set_manager']}
                        </button>
                        <button type="submit" name="action" value="unsetManager" class="btn btn-secondary btn-sm">${sessionScope.language['Unset_manager']}
                        </button>
                    </form>
                </td>
            </tr>
            ...
            <c:if test="${requestScope.currentPage == 1}">
                <div class="btn-group dropright" aria-labelledby="dropdownMenuButton">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="?action=findAllCars&page=${requestScope.currentPage}&noOfRecords=5" role="button">5</a>
                        <a class="dropdown-item" href="?action=findAllCars&page=${requestScope.currentPage}&noOfRecords=10" role="button">10</a>
                        <a class="dropdown-item" href="?action=findAllCars&page=${requestScope.currentPage}&noOfRecords=25" role="button">25</a>
                        <a class="dropdown-item" href="?action=findAllCars&page=${requestScope.currentPage}&noOfRecords=50" role="button">50</a>
                    </div>
                </div>
            </c:if>
            <thead>
    ...
    <c:if test="${not empty requestScope.allCars}">
        <div class="text-center">
            ...
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link" href="?action=findAllCars&page=1&noOfRecords=${requestScope.noOfRecords}">1</a></li>
                <li class="page-item"><a class="page-link" href="?action=findAllCars&page=2&noOfRecords=${requestScope.noOfRecords}">2</a></li>
                <li class="page-item"><a class="page-link" href="?action=findAllCars&page=3&noOfRecords=${requestScope.noOfRecords}">3</a></li>
                <li class="page-item">
