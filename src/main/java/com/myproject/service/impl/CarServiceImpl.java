...
public class CarServiceImpl implements CarService<Car> {
     ...
     */
    @Override
    public Optional<HashMap<List<Car>, Integer>> getAllCars(int currentPage,
                                                            int noOfRecords) throws ServiceException {
        try {
     ...
     */
    @Override
    public Optional<List<Car>> getSortedCars(String sortOrderCommand, int currPage,
                                             int noOfRecords) throws ServiceException {
        String neededQuery;
        switch (sortOrderCommand) {
            case "sortCarsByName":
                neededQuery = QuerySQL.GET_ALL_CARS_SORT_BY_NAME;
                break;

            case "sortCarsByClass":
                neededQuery = QuerySQL.GET_ALL_CARS_SORT_BY_CAR_CLASS;
                break;

            case "sortCarsByBrand":
                neededQuery = QuerySQL.GET_ALL_CARS_SORT_BY_BRAND;
                break;

            case "sortCarsByRentPrice":
                neededQuery = QuerySQL.GET_ALL_CARS_SORT_BY_RENT_PRICE;
                break;

            default:
                neededQuery = QuerySQL.GET_ALL_CARS;
        }
        try {
